...
(function () {
  ...
  css.textContent =
    ...
    "padding:10px 16px;border-radius:999px;background:#0d0a1a;color:#f5f3ff;border:1px solid #2a2140;" +
    "font:500 13px/1 ui-sans-serif,system-ui,sans-serif;cursor:pointer;box-shadow:0 8px 24px rgba(0,0,0,.45);" +
    "transition:border-color .15s}#hm-badge:hover{border-color:#8b5cf6}" +
    "#hm-dot{width:8px;height:8px;border-radius:50%;background:#8b5cf6;box-shadow:0 0 0 0 rgba(163,230,53,.6);" +
