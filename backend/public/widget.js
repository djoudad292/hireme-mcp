...
(function () {
  ...
  css.textContent =
    ...
    "transition:border-color .15s}#hm-badge:hover{border-color:#22d3ee}" +
    "#hm-dot{width:8px;height:8px;border-radius:50%;background:#22d3ee;box-shadow:0 0 0 0 rgba(163,230,53,.6);" +
